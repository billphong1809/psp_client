...
public class AdapterFavoriteListView extends BaseAdapter {
	...
	public AdapterFavoriteListView(Activity activity, List<UserLogin> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(
					R.layout.list_item_fragment_favorite, null);

		if (imageLoader == null)
			imageLoader = AppController.getInstance().getImageLoader();

		NetworkImageView thumnaidAvatar = (NetworkImageView) convertView
				.findViewById(R.id.thumnailFavorite);
		TextView tvUsername = (TextView) convertView
				.findViewById(R.id.tvUsernameFavorite);
